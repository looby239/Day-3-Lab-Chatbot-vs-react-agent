...
I was responsible for **UX Demo + Log Viewer**. My main objective was to make the chatbot/agent system demoable through a web UI and make the ReAct reasoning trace visible to users and instructors.
